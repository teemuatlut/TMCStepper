...
bool TMC2660Stepper::sfilt() { return getBits(SGCSCONF(), cfg.SFILT_bm,	cfg.SFILT_bp); }
uint8_t TMC2660Stepper::sgt(){ return getBits(SGCSCONF(), cfg.SGT_bm, 	cfg.SGT_bp); }
uint8_t TMC2660Stepper::cs() { return getBits(SGCSCONF(), cfg.CS_bm, 	cfg.CS_bp); }
