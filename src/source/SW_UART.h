...
* Definitions
******************************************************************************/
typedef int16_t stm32_pin_t;
#define _SS_MAX_RX_BUFF 64 // RX buffer size
#define SOFTWARE_SERIAL_TIMER Timer4

class SoftwareSerial : public Stream
{
private:
  // per object data
  stm32_pin_t _receivePin;
  stm32_pin_t _transmitPin;
  uint32_t _speed;
...
public:
  ...
  SoftwareSerial(stm32_pin_t receivePin, stm32_pin_t transmitPin, bool inverse_logic = false);
  ~SoftwareSerial();
  void timerInit(void);
