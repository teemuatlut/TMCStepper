...
TMC2130Stepper driver ( *SPI1, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC2130Stepper driver1(sw_spi, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC2160Stepper driver2( *SPI1, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC2160Stepper driver3(sw_spi, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC2660Stepper driver4( *SPI1, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC2660Stepper driver5(sw_spi, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC5130Stepper driver6( *SPI1, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC5130Stepper driver7(sw_spi, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC5160Stepper driver8( *SPI1, {CS_GPIO_Port, CS_Pin}, R_SENSE);
TMC5160Stepper driver9(sw_spi, {CS_GPIO_Port, CS_Pin}, R_SENSE);

TMC2208Stepper driver10(*USART2, R_SENSE);
TMC2209Stepper driver12(*USART2, R_SENSE, 2);
TMC2300Stepper driver14(*USART2, R_SENSE, 3);
